...
' If the ticker name does not match the value
        If (ws.Cells(i, 1).Value <> TickerName) Then

' First instance of a new ticker name, set opening price and copy ticker name
...
' If the next ticker name is a new name set the closing price of the current ticker
...
' Conditional formatting green for anything above 0 and red for anything below 0
...
' Set the percentage change for the current ticker
...
' Set the names for the required columns
